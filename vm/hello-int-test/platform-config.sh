...
export secretObjects="[map[data:[map[sourcePath:application-secret targetKey:application-secret-value]] name:application-secret type:Opaque] map[data:[map[sourcePath:git-hub-user targetKey:username] map[sourcePath:git-hub-token targetKey:password]] name:gh-repo-secret type:Opaque] map[data:[map[sourcePath:acr-secret targetKey:.dockerconfigjson]] name:acr-secret type:kubernetes.io/dockerconfigjson]]"
